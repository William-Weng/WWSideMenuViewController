...
public extension WWItemViewController {
    ...
    ///   - curve: 動畫型式
    /// - Returns: Bool
    func display(with direction: WWSideMenuViewController.Constant.MenuPopupDirection = .right, duration: TimeInterval = 0.25, curve: UIView.AnimationCurve = .linear) -> Bool {
    ...
    ///   - curve: 動畫型式
    /// - Returns: Bool
    func dismiss(with direction: WWSideMenuViewController.Constant.MenuPopupDirection = .right, duration: TimeInterval = 0.25, curve: UIView.AnimationCurve = .linear) -> Bool {
