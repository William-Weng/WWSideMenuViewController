...
```bash
dependencies: [
    .package(url: "https://github.com/William-Weng/WWSideMenuViewController.git", .upToNextMajor(from: "1.3.0"))
]
```
...
|函式|說明|
|-|-|
|initSetting(with:visualEffectStyle:menuSegueIdentifier:delegate:)|初始化設定|
